<?php
		  ...
		  if (isset($_SESSION['appointment_success']) && $_SESSION['appointment_success'] === true) {
			echo "<script>alert('Hostel Manager Appointed Successfully');</script>";
			unset($_SESSION['appointment_success']); // Unset the session variable
		}
	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand" href="admin_home.php">Gomal</a></h1>
