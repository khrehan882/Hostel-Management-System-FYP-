...
<header>
	<div class="container agile-banner_nav">
		<nav class="navbar navbar-expand-lg navbar-light">
			...
			<h1><a class="navbar-brand mr-2" href="admin_home.php">gomal<span class="display"></span></a></h1>
          ...
          <li class="nav-item">
						<a class="nav-link" href="create_hm.php">Appoint/Remove Manager</a>
					</li>
					<li class="nav-item">
				...
				<li class="visible">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-1)" xlink:href="../web_home/images/select.png"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
