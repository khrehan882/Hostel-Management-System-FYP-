	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand" href="home.php">Gomal <span class="display"></span></a></h1>
...
<?php
    if(isset($_POST['submit'])){
        ...
        if ($row6) {
            ...
            echo "<script type='text/javascript'>alert('Hostel Manager not found for the selected hostel!')</script>";
        }
    }
?>